...
def write_in_script(sigma, numParticleTypes, PatchRange, PatchStrength, IsotropicAttrRange, IsotropicAttrStrength, real,
                    RunSteps, dumpevery, filePattern, configName, ResultsFolder, extForce, clusterevery):
    seed = 100 + real
    ...
    f.write("\nrun                    {:d}  post yes  every {:d}  'fix  fRigidNVE all rigid  custom v_vClu  reinit yes' \n".format(RunSteps, clusterevery))
...
if __name__ == "__main__":
    ...
    inputscriptfile = write_in_script(sigma, system.numTypes, PatchRange, PatchStrength, IsotropicAttrRange,
                                      ...
                                      ResultsFolder, extForce, clusterevery)
